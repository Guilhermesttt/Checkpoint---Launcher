...
const UPDATE_COPY = {
  ...
  "en-US": ["System Updates", "Currently installed version", "Keep Checkpoint Launcher up to date.", "Checking for updates...", "A new version is available to download.", "You already have the latest version.", "Downloading update", "Update ready to install.", "Local development environment.", "Unable to check for updates.", "Check for Updates", "Download and Update", "Restart and Update"],
