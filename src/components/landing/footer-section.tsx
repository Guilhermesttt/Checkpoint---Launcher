      ...
      <div className="relative w-full h-[200px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            <img src="/Pherielium_logo.png" alt="Phelierium" className="w-12 h-12 object-contain opacity-10 mx-auto mb-3" />
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="py-12 flex flex-col md:flex-row items-center justify-between gap-6">
          <a href="#" className="inline-flex items-center gap-2">
            <img src="/Pherielium_logo.png" alt="Phelierium" className="w-6 h-6 object-contain opacity-70" />
