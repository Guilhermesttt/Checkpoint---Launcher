  ...
  return (
    ...
    >
      <mesh castShadow receiveShadow position={[0, 0, -0.015]}>
        ...
        <meshStandardMaterial color="#171615" roughness={0.58} metalness={0.08} />
      </mesh>
      ...
      <RetroDisc game={game} visible={motion.discVisible} reducedMotion={!motion.rotateDisc} />

      <group ref={frontCoverRef} position={[-0.73, 0, 0.06]}>
